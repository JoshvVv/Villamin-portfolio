                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#updateModal" data-id="{{$item->id}}" data-name="{{$item->name}}" data-email="{{$item->email}}" data-description="{{$item->description}}" data-role="{{$item->role}}" data-image="{{$item->image}}">
                          Edit
                        </button>
                        <form class="less" action="{{route('skill.delete', ['id'=>$item->id])}}" method="post">
                          @csrf
                          @method('delete')
  ...
  <div class="modal-dialog  modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('skill.add')}}" class="row g-3" enctype="multipart/form-data" method="POST">
          @csrf
          @method('post')
          <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <input type="text" class="form-control" name="role" id="inputEmail4">
            </div>
        </div>
        <div class="mb-3">
 ...
 <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
  <div class="modal-dialog  modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="row g-3" action="{{route('skill.update', ['id'=>'__ID__'])}}" method="POST" id="updateForm">
          @csrf
          @method('put')
          <div class="col-md-6">
       ...
       <script>
        ...
        myModal.addEventListener('show.bs.modal', function(event) {
            ...
            document.getElementById('formFile').value = image;
        });
    </script>
      </div>
      <div class="modal-footer">
